...
class LostPasswordControl extends \Nette\Application\UI\Control
{
	...
	public function render()
	{
		...
		$this->template->setFile(\zvitek\Helper::control_template(__DIR__,'LostPassword'));
	...
	public function lostPasswordForm_submitted(\Nette\Application\UI\Form $form)
	{
		...
		if($user)
		{
			...
			if(!count($dataToSend))
			{
				$this->getPresenter()->flashMessage('Při zpracovávání žádosti došlo k chybě. Prosím kontaktujte administrátora', 'error');
