...
class VisualPaginator extends \Nette\Application\UI\Control
{
    ...
    {
        $this->template->kpzFilter = $this->kpzFilter == NULL ? NULL : $this->kpzFilter;
        ...
        if($this->getParent()->getName() == 'subscribersList')
        {
            $this->getParent()->filter = $this->getParent()->prepareFilter($this->filter);
        }
